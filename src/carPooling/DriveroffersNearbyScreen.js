...
const OfferItem = props => {
  ...
  console.log(props);
  return (
  <TouchableOpacity onPress={props._DriverDetail}>
          ...
          <View style={styles.offerDetail}>
            <View style={styles.offerDetailRow}>
              ...
              <Text style={styles.rowLabel}>
                {item.from_street}, {item.from_city}, {item.from_country}
              </Text>
            </View>
            <View style={styles.offerDetailRow}>
              <View style={styles.rowIcon}>
              ...
              <Text style={styles.rowLabel}>
                {item.to_street}, {item.to_city}, {item.to_country}
              </Text>
            </View>
            <View style={styles.offerDetailRow}>
...
export default class DriveroffersNearbyScreen extends Component {
  ...
  _renderItem = ({item}) => {
    return <OfferItem item={item} _DriverDetail={()=>this._DriverDetail(item)}/>;
  };
  ...
  _search = async () => {
    ...
    const path = '/api/v1/passenger/search';
    const params = {
